...
namespace AcademyResidentInformationApi.Tests.V1.E2ETests
{
    ...
    {
        public static ResidentInformation AddPersonWithRelatesEntitiesToDb(AcademyContext context, int? id = null, string firstname = null, string lastname = null, string postcode = null, string addressLines = null)
        {
